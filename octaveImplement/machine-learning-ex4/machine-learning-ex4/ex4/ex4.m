...
% Unroll parameters 
% Depend on network achitecture, input  layer have 400 units (not counting the extra bias unit which always outputs +1). 
%                                hidden layer have 25  units.
%                                output layer have 10  output units(corresponding to the 10 digit classes).
% So  theta1 have size 25 by 401
% and theta2 have size 10 by 26 [(Sj+1)*Sj+1]
